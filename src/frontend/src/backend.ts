...
import type { Cell as _Cell, ChatMessage as _ChatMessage, ClassroomDuration as _ClassroomDuration, ClassroomId as _ClassroomId, ClassroomView as _ClassroomView, Error as _Error, FileRef as _FileRef, Result as _Result, Result__1 as _Result__1, Timestamp as _Timestamp, UserRole as _UserRole, Value as _Value } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async searchClassrooms(arg0: string, arg1: Timestamp | null): Promise<Array<ClassroomView>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchClassrooms(arg0, to_candid_opt_n29(this._uploadFile, this._downloadFile, arg1));
                return from_candid_vec_n28(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async sendChatMessage(arg0: string, arg1: FileRef | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.sendChatMessage(arg0, to_candid_opt_n30(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_FileRef]): FileRef | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        file: record_opt_to_undefined(from_candid_opt_n27(_uploadFile, _downloadFile, value.file)),
...
function from_candid_vec_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ClassroomView>): Array<ClassroomView> {
...
function to_candid_opt_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FileRef | null): [] | [_FileRef] {
    return value === null ? candid_none() : candid_some(value);
}
